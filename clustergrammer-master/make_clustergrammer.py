...
net.write_json_to_file('viz', '/../../../../../pulmon/json/mult_view.json', 'indent')
net.write_json_to_file('sim_row', '/pulmon/json/mult_view_sim_row.json', 'no-indent')
net.write_json_to_file('sim_col', '/pulmon/json/mult_view_sim_col.json', 'no-indent')
